...
YAML FRONT MATTER (lines 1-20)
  ...
  [x] image           — genuine hero.jpg generated 2026-08-25
...
![A smartphone resting screen-up on a wooden desk beside a closed laptop, connected by a visible cable, suggesting a private link between the two devices.](media/images/hero.jpg){.img-fluid width=80% fig-align="center"}
...
![A small brass padlock resting on a folded paper map with a single dotted line drawn between two marked points.](media/images/ambiance1.jpg){.img-fluid height=3.5in}
...
![A pocket-sized leather notebook lying open next to a laptop, both showing the same short handwritten list, suggesting mirrored, synchronized content.](media/images/ambiance2.jpg){.img-fluid height=3.5in}
...
![A closed laptop on a desk in dim evening light, with a smartphone glowing softly nearby, suggesting an unattended session still quietly running.](media/images/ambiance3.jpg){.img-fluid height=3.5in}
...
[x] Visual design
    [x] 1 hero image (width=80%) — genuine, generated 2026-08-25
    [x] 3 ambiance images (width=100%) — all genuine, generated 2026-08-25
...
This post is not part of the core onboarding sequence: its
scenario (a single Ubuntu laptop plus a phone browser) is a
niche, advanced remote-access convenience, not something needed
to get a new lab member's primary machine productive. It belongs
to a separate, smaller *Workflow Extensions* grouping alongside
[LLM-Augmented Editing for the Workflow Construct](../wf-claude-code-in-shell/).

**Core onboarding series** (*Workflow Construct*), for readers who
have not yet completed the base setup:
