...
interface, and wrapping of the service in a per-user systemd unit
that survives logout and reboot. It also covers client-side
configuration on iOS and optional hardening with a TLS certificate
issued by `tailscale cert`.
